<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="matricula" value="{{ __('Matrícula') }}" />
                <x-jet-input id="matricula" class="block mt-1 w-full" type="text" name="matricula" :value="old('matricula')" required autocomplete="matricula" />
            </div>
